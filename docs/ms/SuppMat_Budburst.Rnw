...
print(xtable(nonbbmodel.table, caption = "Summary of mixed-effects model of budburst success (estimates presented on logit scale). See also Figure S2."), 
...
print(xtable(nonlomodel.table, caption = "Summary of mixed-effects model of leafout success (estimates presented on logit scale). See also Figure S3."), 
      include.rownames=TRUE, 
      caption.placement = "top",
      sanitize.rownames.function = function(x) {x})
@ 
...
print(xtable(meanzb.table, caption = "Summary of mixed-effects model of budburst day. See also Figure S4"), 
      include.rownames=TRUE, 
      caption.placement = "top",
      sanitize.rownames.function = function(x) {x})
@ 
...
# \ref{fig:figS3}
print(xtable(meanzl.table, caption = "Summary of mixed-effects model of leafout day. See also Figure S5."), 
      include.rownames=TRUE, 
      caption.placement = "top",
      sanitize.rownames.function = function(x) {x})
@
