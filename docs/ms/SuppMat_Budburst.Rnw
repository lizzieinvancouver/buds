...
print(xtable(meanzb.table, caption = "Summary of mixed-effects model of budburst day by species. See also Figure S2."), 
...
print(xtable(meanzl.table, caption = "Summary of mixed-effects model of leafout day by species. See also Figure S3."), 
      include.rownames=TRUE, 
      caption.placement = "top",
      sanitize.rownames.function = function(x) {x})
@
