...
\begin{table}[ht]
\centering
\caption{Summary of mixed effect model of budburst day by species. See also Figure S2.} 
...
\begin{table}[ht]
\centering
\caption{Summary of mixed effect model of leafout day by species. See also Figure S3.} 
\begin{tabular}{rrrrrrr}
  \hline
 & mean & sd & 2.5\% & 50\% & 97.5\% & Rhat \\ 
  \hline
