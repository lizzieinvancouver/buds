...
\begin{center}
\textbf{\Large{Supplemental Materials \vspace{1ex}\\Temperature and photoperiod interactively drive spring phenology across all species in a temperate forest community}}
...
\noindent\emph{Additional method details}

\noindent In our figures we show 50\% credible intervals because our interest is in the most likely value for the parameter and because 50\% intervals are computational stable. For those interested in a more traditional significance-testing approach, we provide 95\% credible intervals in Table S2-S3. 
