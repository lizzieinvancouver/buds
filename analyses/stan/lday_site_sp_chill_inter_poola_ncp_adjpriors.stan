...
/*	mu_b_inter_wp ~ normal(0, 35); // Delete because all in NCP now
	...
	sigma_b_warm ~ normal(0, 30); // Start big, go smaller if introduces problems
	sigma_b_photo ~ normal(0, 30); 
	sigma_b_chill1 ~ normal(0, 30);
	sigma_b_chill2 ~ normal(0, 30);
	sigma_b_site ~ normal(0, 30);

	sigma_b_inter_wp ~ normal(0, 30);
	sigma_b_inter_ws ~ normal(0, 30);
	sigma_b_inter_ps ~ normal(0, 30);
	sigma_b_inter_wc1 ~ normal(0, 30);	
	sigma_b_inter_wc2 ~ normal(0, 30);	
	sigma_b_inter_pc1 ~ normal(0, 30);	
	sigma_b_inter_pc2 ~ normal(0, 30);	
	sigma_b_inter_sc1 ~ normal(0, 30);	
	sigma_b_inter_sc2 ~ normal(0, 30);
...
/*	b_inter_wp ~ normal(mu_b_inter_wp, sigma_b_inter_wp); // Delete because all in NCP now
	...
	b_inter_sc2 ~ normal(mu_b_inter_sc2, sigma_b_inter_sc2); */
        b_inter_wp_ncp ~ normal(0, 105); 
        b_inter_ws_ncp ~ normal(0, 105);
	b_inter_ps_ncp ~ normal(0, 105);
	b_inter_wc1_ncp ~ normal(0, 105);		
	b_inter_wc2_ncp ~ normal(0, 105);
	b_inter_pc1_ncp ~ normal(0, 105);		
	b_inter_pc2_ncp ~ normal(0, 105);
	b_inter_sc1_ncp ~ normal(0, 105);		
	b_inter_sc2_ncp ~ normal(0, 105);
