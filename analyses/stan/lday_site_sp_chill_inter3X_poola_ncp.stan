...
// Note by Lizzie: This model includes pooled intercepts and a 3X interaction for warm*photo*chill1
...
parameters {
  ...
  real<lower=0> sigma_b_inter_wpc1;
...
transformed parameters { // Vectorize: Won't save time probably here (no scalar x vector)
  ...
  b_inter_wpc1 = mu_b_inter_wpc1 + sigma_b_inter_wpc1*b_inter_wpc1_ncp;
